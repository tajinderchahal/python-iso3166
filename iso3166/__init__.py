...
_records = [
    ...
    Country(u"The Bahamas", "BS", "BHS", "044", u"Bahamas"),
    ...
    Country(u"Republic of the Congo", "CG", "COG", "178", u"Congo"),
    Country(u"Democratic Republic of the Congo", "CD", "COD", "180",
    ...
    Country(u"Cote d'Ivoire", "CI", "CIV", "384", u"Côte d'Ivoire"),
    ...
    Country(u"The Gambia", "GM", "GMB", "270", u"Gambia"),
    ...
    Country(u"Macedonia (FYROM)", "MK", "MKD", "807",
    ...
    Country(u"Myanmar (Burma)", "MM", "MMR", "104", u"Myanmar"),
    ...
    Country(u"Pitcairn Islands", "PN", "PCN", "612", u"Pitcairn"),
    ...
    Country(u"Vietnam", "VN", "VNM", "704", u"Vietnam"),
    ...
    Country(u"Vatican City", "VA", "VAT", "336", u"Vatican City")]
